...
class extract_file_system_content:
    ...
    def __init__(self, title, object_id, path, registry=None, aggregate=False, aggregate_key=None):
    ...
    def init_components(self):
        ...
        self.web_obj_button = widgets.Button(description="Upload", disabled=False, button_style="info",
                                             tooltip="upload", icon="check")
        self.file_obj_path = widgets.Text(value="/data", disabled=False, description="source")
        self.file_obj_button = widgets.Button(description="Import", disabled=False, button_style="info",
                                              tooltip="import", icon="check")
        self.existing_reference = widgets.Dropdown(options=[], description="Existing %s" % self.object_id)
        self.existing_button = widgets.Button(description="Select", disabled=False, button_style="info",
                                              tooltip="select", icon="check")
