...
def map_methylation_signal_chunk(
    ...
    if methylation_chunk is None:
        ...
        # print(bam_chunk.drop("cigar", axis=1))
        
        # print(mung_bam_variant(bam_chunk, ref = ref.get_whole_sequence(chromosome), chromosome=chromosome))
        ...
        with concurrent.futures.ProcessPoolExecutor(max_workers=8) as pool:
            ...
            for key in keys:
                ...
                # print(mung_bam_variant(read_chunk, ref = ref.get_whole_sequence(chromosome), chromosome=chromosome))
...
def map_methylation_signal(ref, bam, modifications):
    ...
    for chromo in ref.get_chromosomes():
        print(chromo)
        chromosome_tiles = ref.get_tiled_chromosome(chromo, tile_size=10000000)
        for index in chromosome_tiles.df.index:
            print(index)
            mapped_reads = map_methylation_signal_chunk(
