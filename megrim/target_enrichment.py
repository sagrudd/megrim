...
class TargetEnrichment(Flounder):
    ...
    def get_on_target(self):
        ...
        ::
            ...
            |-------------+-----------+-----------+--------------+-----------|
            | 1           | 155179779 | 155195266 | 274.39789305 | MUC1      |
            | 4           | 3072436   | 3079444   | 1060.255563  | HTT       |
            | 6           | 170554805 | 170563019 | 926.0217326  | SCA17     |
            | 9           | 27572666  | 27576436  | 521.1355783  | C9orf72   |
            | ...         | ...       | ...       | ...          | ...       |
            | X           | 147910539 | 147931116 | 597.4970262  | FMR1      |
            | 22          | 45791084  | 45797924  | 1638.6897613 | SCA10     |
            | 19          | 13205097  | 13210441  | 810.1785118  | SCA6      |
            | 14          | 92067404  | 92073500  | 1261.893 12  | SCA3      |
            +-------------+-----------+-----------+--------------+-----------+
